...
function displayCountry(countryName){
    ...
    document.querySelector('.translations-button').addEventListener('click',()=>{
        document.querySelector('.translations-button .left').classList.toggle('hide')
        document.querySelector('.translations-button .right').classList.toggle('hide')
        document.querySelector('.translations-list').classList.toggle('hide')
    })
