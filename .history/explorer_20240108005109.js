...
function countryInfoTasform(info,type=""){
        if(typeof info === 'object'){
            ...
            let content = `<div class="flex"><img src="./images/left-arrow.png" class="left stop" alt="left arrow"><ul>` ; 
            info.forEach((item,index)=>{
                let hide = index != 0 ? "hide" : "" ;
                content += `<li class="${hide}"><h3>${item}</h3></li>` ; 
            })
            content += `</ul><img src="./images/right-arrow.png" class="right" alt="right arrow"></div>` ; 
            return content ; 
        }else{
