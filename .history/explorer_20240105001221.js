        ...
        let {   name,flags,
            ...
            section.innerHTML = `<div class="country-names-flag">
                                ...
                                <div className="translations-caroussel">
                                    ...
                                    <ul role="list" class="translations-list">
...
function translationLanguagesList(translations,nativeName){
    ...
    for (let  key of nativeKeys) {
     ...
     console.log(nativeKeys.indexOf("ara"));
     console.log(nativeKeys.indexOf("ber"));
     console.log(translationsCode)
     translationsCode.sort((a,b)=>{
            if((nativeKeys.includes(a) && !nativeKeys.includes(b)) || (nativeKeys.indexOf(a)+1 < nativeKeys.indexOf(b)+1)){
                return 1 ; 
            }else if((!nativeKeys.includes(a) && nativeKeys.includes(b)) || (nativeKeys.indexOf(a)+1 > nativeKeys.indexOf(b)+1)){
                return -1
            }else{
                return 0 ; 
            }
    ...
    //  for(let code  in translationsCode){
    //        translationsList += `<li className="translation-item" data-language-code="${code}">${value}</li>`;
    //  }
}