...
let borders = countries.filter(country=>{bordersCodes.includes(country.cca3) || bordersCodes.includes(country.cca2) || bordersCodes.includes(country.ccn3) ||bordersCodes.includes(country.cioc) })
