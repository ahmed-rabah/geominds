            ...
            section.innerHTML = `<div class="country-names-flag">
                                ...
                                <div className="translations-caroussel">
                                    ...
                                    <ul role="list" class="translations-list">
                                        translationLanguagesList${translationLanguagesList(translations,name.nativeName)}
                                    </ul>
                                </div>
                                </div>
...
function translationLanguagesList(translations,nativeName){
    ...
    for (let  key of nativeKeys) {
     ...
     translationsCode.forEach(code => {
         translationsList += `<li className="translation-item" data-language-code="${code}">${languageInfo(code)}</li>`;
     })
